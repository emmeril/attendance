function attendanceApp() {
  ...
  return {
    ...
    employeeForm: { employee_code:'', name:'', department:'', position:'', shift_id:'', device_user_id:'', machine_mappings:{} },
