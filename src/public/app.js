function attendanceApp() {
  ...
  return {
    ...
    async testDevice(device) { try { await this.request(`/api/devices/${device.id}/test`, { method:'POST', body:'{}' }); this.notify(`${device.name} terhubung.`); await this.loadDevices(); } catch(e) { this.notify(`Koneksi gagal: ${e.message}`); } },
